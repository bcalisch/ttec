...
import { Project, CreateProjectRequest, ProjectBoundary, CoverageCell } from '../models';
...
export class ProjectService {
  ...
  getCoverage(id: string): Observable<{gridSize: number, cells: CoverageCell[], gaps: number}> {
    return this.http.get<{gridSize: number, cells: CoverageCell[], gaps: number}>(`/api/projects/${id}/coverage`);
  }
}
